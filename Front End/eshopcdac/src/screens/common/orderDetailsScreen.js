...
const OrderDetailsScreen = (props) => {
  ...
  const myOrderStore = useSelector((store)=> store.viewMyOrderStore)
                ...
                <div className="card-body">
                  <div
                    ...
                    <table className="table my-0" id="dataTable">
                      ...
                      <tbody>
                        {myOrderStore.response &&
                          myOrderStore.response.data &&
                          myOrderStore.response.data.length > 0 &&
                          myOrderStore.response.data.map((p) => 
